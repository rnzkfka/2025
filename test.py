...
universities = {
    ...
    "인천": {
        "인하대학교": ["기계공학부", "전자공학과", "경영학과", "영어영문학과", "수학과"],
        "가천대학교": ["컴퓨터공학과", "의학과", "간호학과", "경영학과", "심리학과"],
        "인천대학교": ["사회복지학과", "화학과", "국어국문학과", "법학과", "경영학과"],
        "청운대학교": ["관광경영학과", "체육학과", "미디어학과", "디자인학과", "심리학과"],
        "재능대학교": ["간호학과", "사회복지학과", "유아교육과", "컴퓨터공학과", "관광학과"],
    },
    "경기": {
        "경기대학교": ["경영학과", "국어국문학과", "전자공학과", "관광경영학과", "심리학과"],
        "아주대학교": ["의학과", "수학과", "경영학과", "기계공학과", "화학과"],
        "성균관대학교(수원)": ["법학과", "경영학과", "컴퓨터공학과", "물리학과", "전자공학과"],
        "단국대학교(죽전)": ["경영학과", "화학과", "건축학과", "미디어학과", "체육학과"],
        "한양대학교(ERICA)": ["컴퓨터공학과", "경영학과", "전자공학과", "디자인학과", "사회학과"],
    },
    "강원": {
        "강원대학교": ["경영학과", "국어국문학과", "컴퓨터공학과", "간호학과", "법학과"],
        "한림대학교": ["의학과", "간호학과", "심리학과", "사회복지학과", "경영학과"],
        "상지대학교": ["영어영문학과", "경영학과", "체육학과", "관광학과", "유아교육과"],
        "춘천교육대학교": ["초등교육과", "국어교육과", "수학교육과", "과학교육과", "사회교육과"],
        "가톨릭관동대학교": ["의학과", "간호학과", "체육학과", "사회복지학과", "심리학과"],
    },
    "충북": {
        "충북대학교": ["국어국문학과", "경영학과", "의학과", "전기전자공학부", "법학과"],
        "청주대학교": ["언론정보학과", "심리학과", "경영학과", "간호학과", "화학과"],
        "한국교원대학교": ["교육학과", "국어교육과", "수학교육과", "영어교육과", "과학교육과"],
        "서원대학교": ["사회복지학과", "체육학과", "경영학과", "컴퓨터공학과", "미술학과"],
        "극동대학교": ["항공서비스학과", "간호학과", "유아교육과", "경찰행정학과", "관광경영학과"],
    },
    "충남": {
        "충남대학교": ["국어국문학과", "경영학과", "의학과", "컴퓨터공학부", "법학과"],
        "공주대학교": ["국어교육과", "체육교육과", "경영학과", "컴퓨터공학과", "영어교육과"],
        "순천향대학교": ["의학과", "간호학과", "경영학과", "사회복지학과", "심리학과"],
        "호서대학교": ["디자인학과", "경영학과", "미디어학과", "컴퓨터공학과", "화학과"],
        "남서울대학교": ["사회복지학과", "유아교육과", "관광학과", "체육학과", "간호학과"],
    },
    "전북": {
        "전북대학교": ["국어국문학과", "경영학과", "의학과", "전자공학과", "법학과"],
        "원광대학교": ["한의학과", "경영학과", "사회복지학과", "간호학과", "심리학과"],
        "우석대학교": ["유아교육과", "특수교육과", "컴퓨터공학과", "관광경영학과", "체육학과"],
        "예원예술대학교": ["음악과", "미술학과", "무용과", "연극학과", "디자인학과"],
        "군산대학교": ["기계공학과", "해양학과", "컴퓨터공학과", "경영학과", "화학과"],
    },
    "전남": {
        "목포대학교": ["경영학과", "국어국문학과", "수학과", "해양학과", "법학과"],
        "순천대학교": ["사회복지학과", "심리학과", "경영학과", "국어교육과", "영어교육과"],
        "목포해양대학교": ["해양학과", "수산학과", "전자공학과", "기계공학과", "경영학과"],
        "동신대학교": ["한의학과", "간호학과", "물리치료학과", "사회복지학과", "심리학과"],
        "광양보건대학교": ["간호학과", "물리치료학과", "유아교육과", "사회복지학과", "관광경영학과"],
    },
    "경북": {
        "안동대학교": ["국어국문학과", "경영학과", "체육학과", "사회복지학과", "수학과"],
        "포항공과대학교": ["컴퓨터공학과", "물리학과", "화학과", "수학과", "전자공학과"],
        "대구가톨릭대학교": ["간호학과", "사회복지학과", "심리학과", "음악과", "미술학과"],
        "한동대학교": ["국제어문학부", "경영학부", "법학부", "컴퓨터공학부", "심리학부"],
        "경일대학교": ["경영학과", "관광경영학과", "디자인학과", "컴퓨터공학과", "체육학과"],
    },
    "경남": {
        "경상국립대학교": ["국어국문학과", "경영학과", "의학과", "수학과", "전자공학과"],
        "창원대학교": ["경영학과", "심리학과", "컴퓨터공학과", "화학과", "법학과"],
        "인제대학교": ["의학과", "간호학과", "사회복지학과", "심리학과", "경영학과"],
        "경남대학교": ["경찰행정학과", "관광경영학과", "체육학과", "컴퓨터공학과", "경영학과"],
        "진주교육대학교": ["초등교육과", "국어교육과", "수학교육과", "과학교육과", "사회교육과"],
    },
    "세종": {
        "한국교통대학교(세종)": ["경영학과", "국어국문학과", "컴퓨터공학과", "법학과", "수학과"],
        "고려대학교(세종)": ["영어영문학과", "경영학과", "컴퓨터공학과", "전자공학과", "수학과"],
        "홍익대학교(세종)": ["디자인학과", "경영학과", "건축학과", "컴퓨터공학과", "심리학과"],
        "세종대학교(세종캠)": ["경영학과", "관광경영학과", "사회복지학과", "체육학과", "컴퓨터공학과"],
        "카이스트 세종": ["컴퓨터공학과", "전자공학과", "물리학과", "수학과", "화학과"],
    },
    "울산": {
        "울산대학교": ["경영학과", "국어국문학과", "의학과", "컴퓨터공학과", "법학과"],
        "울산과학기술원": ["컴퓨터공학과", "화학과", "물리학과", "수학과", "전자공학과"],
        "울산과학대학교": ["간호학과", "사회복지학과", "유아교육과", "체육학과", "관광경영학과"],
        "춘해보건대학교": ["간호학과", "물리치료학과", "유아교육과", "사회복지학과", "보건학과"],
        "한국폴리텍대학 울산": ["기계공학과", "전기전자공학과", "컴퓨터공학과", "디자인학과", "경영학과"],
    },
    "제주": {
        "제주대학교": ["국어국문학과", "경영학과", "수학과", "컴퓨터공학과", "의학과"],
        "제주국제대학교": ["관광경영학과", "사회복지학과", "체육학과", "경영학과", "영어영문학과"],
        "한라대학교": ["간호학과", "컴퓨터공학과", "경영학과", "심리학과", "유아교육과"],
        "제주관광대학교": ["관광경영학과", "호텔경영학과", "항공서비스학과", "경영학과", "체육학과"],
        "제주한라대학교": ["간호학과", "사회복지학과", "컴퓨터공학과", "유아교육과", "디자인학과"],
    },
}
...
department_descriptions = {
    ...
    "컴퓨터공학과": "프로그래밍과 컴퓨터 시스템을 배우는 학과입니다.",
    "전기전자공학부": "전기와 전자 시스템을 연구하는 학과입니다.",
    "전자공학과": "전자 회로와 반도체를 연구하는 학과입니다.",
    ...
    "미디어학과": "미디어 이론과 콘텐츠 제작을 배우는 학과입니다.",
    "디자인학과": "시각 및 산업 디자인을 배우는 학과입니다.",
    "관광경영학과": "관광 산업과 경영을 배우는 학과입니다.",
    "관광학과": "관광 자원과 산업을 연구하는 학과입니다.",
    ...
    "한의학과": "한의학적 치료와 연구를 배우는 학과입니다.",
    "물리치료학과": "환자의 재활과 운동 치료를 연구하는 학과입니다.",
    "국제어문학부": "다양한 외국어와 문학을 연구하는 학과입니다.",
    "경찰행정학과": "경찰 제도와 범죄 예방을 연구하는 학과입니다.",
    "건축학과": "건축 설계와 구조를 연구하는 학과입니다.",
    "초등교육과": "초등학생 교육을 위한 교사를 양성하는 학과입니다.",
    "국어교육과": "국어 교사를 양성하기 위한 학과입니다.",
    "영어교육과": "영어 교사를 양성하기 위한 학과입니다.",
    "수학교육과": "수학교사를 양성하기 위한 학과입니다.",
    "과학교육과": "과학교사를 양성하기 위한 학과입니다.",
    "사회교육과": "사회 교사를 양성하기 위한 학과입니다.",
    "교육학과": "교육학 이론과 정책을 연구하는 학과입니다.",
    "보건학과": "보건의료와 공중보건을 배우는 학과입니다.",
}
# -------------------------
# 3. 대학교 대표 색상
# -------------------------
